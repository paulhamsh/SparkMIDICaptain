...
const SparkPreset preset0{0x0,0x7f,"07079063-94A9-41B1-AB1D-02CBC5D00790","Silver Ship","0.7","1-Clean","icon.png",120.000000,7,{ 
...
const SparkPreset preset1{0x0,0x7f,"CDE99591-C05D-4AE0-9E34-EC4A81F3F84F","Sweet Memory","0.7","1-Clean","icon.png",120.000000,7,{ 
...
const SparkPreset preset2{0x0,0x7f,"F577F7F3-E8E0-4D35-8975-0427C2054DCE","Dancing in the room","0.7","Description for Blues Preset 1","icon.png",120.000000,7,{ 
...
const SparkPreset preset3{0x0,0x7f,"D8757D67-98EA-4888-86E5-5F1FD96A30C3","Royal Crown","0.7","1-Clean","icon.png",120.000000,7,{ 
...
const SparkPreset preset4{0x0,0x7f,"9D2F2AA3-4EC5-4BD7-A3CD-A76FD55698DB","Wooden Bridge","0.7","Description for Blues Preset 1","icon.png",120.000000,7,{ 
...
const SparkPreset preset5{0x0,0x7f,"B08F2421-0686-484E-B6EC-8F660A9344FC","Stone Breaker","0.7","Description for Blues Preset 1","icon.png",120.000000,7,{ 
...
const SparkPreset preset6{0x0,0x7f,"55D60EB5-1735-4746-B0C4-16C53D8CA203","Country road","0.7","Description for Blues Preset 1","icon.png",120.000000,7,{ 
...
const SparkPreset preset7{0x0,0x7f,"2E2928B5-D87E-4346-B58F-145B88C581BE","Blues Ark","0.7","1-Clean","icon.png",120.000000,7,{ 
...
const SparkPreset preset8{0x0,0x7f,"BB40E550-77D0-40B1-B0D3-D15D3D0C19EE","Modern Stone","0.7","Description for Rock Preset 1","icon.png",120.000000,7,{ 
...
const SparkPreset preset9{0x0,0x7f,"BFCFC107-6E80-4F26-8549-F44638856241","Crazy Crue","0.7","1-Clean","icon.png",120.000000,7,{ 
...
const SparkPreset preset10{0x0,0x7f,"6AF9D829-CEA7-4189-AC80-B3364A563EB4","Dark Soul","0.7","1-Clean","icon.png",120.000000,7,{ 
...
const SparkPreset preset11{0x0,0x7f,"7984DF4F-5885-4FE2-9786-F3F31E322E44","British Accent","0.7","Description for Pop Preset 1","icon.png",120.000000,7,{ 
...
const SparkPreset preset12{0x0,0x7f,"96E26248-0AA3-4D45-B767-8BB9337346C9","Iron Hammer","0.7","Description for Metal Preset 1","icon.png",120.000000,7,{ 
...
const SparkPreset preset13{0x0,0x7f,"82C5B8E8-7889-4302-AC19-74DF543872E1","Millenial Lead","0.7","Description for Metal Preset 1","icon.png",120.000000,7,{ 
...
const SparkPreset preset14{0x0,0x7f,"5F27120E-5119-4923-ADA9-42CCB5B01A95","Heavy Axe","0.7","Description for Metal Preset 1","icon.png",120.000000,7,{ 
...
const SparkPreset preset15{0x0,0x7f,"961F7F40-77C3-4E98-A694-DF9CA4069955","Dual Train","0.7","Description for Rock Preset 1","icon.png",120.000000,7,{ 
...
const SparkPreset preset16{0x0,0x7f,"94109418-E7D9-4B99-83F7-DDB11CA5847D","Spooky Melody","0.7","Description for Alternative Preset 1","icon.png",120.000000,7,{ 
...
const SparkPreset preset17{0x0,0x7f,"E237C4CF-172B-4D68-AA5B-659F57715658","Fuzzy Jam","0.7","Description for Alternative Preset 1","icon.png",120.000000,7,{ 
  {"bias.noisegate", true, 2, {0.500000, 1.000000}}, 
...
const SparkPreset preset18{0x0,0x7f,"A3601E1D-8018-42A8-9A19-9B6F0DAB6F46","Angry Monkey","0.7","Description for Alternative Preset 1","icon.png",120.000000,7,{ 
  {"bias.noisegate", true, 2, {0.500000, 1.000000}}, 
  {"BlueComp", true, 4, {0.389830, 0.665254, 0.305085, 0.644068}}, 
...
const SparkPreset preset19{0x0,0x7f,"50A3B945-1A86-4E06-B10B-550E3226DDF2","Hide and Seek","0.7","Description for Alternative Preset 1","icon.png",120.000000,7,{ 
  {"bias.noisegate", true, 2, {0.500000, 1.000000}}, 
...
const SparkPreset preset20{0x0,0x7f,"3013444B-9929-499F-964D-707E9D8F5FA0","Bass Driver","0.7","Description for Bass Preset 1","icon.png",120.000000,7,{ 
...
const SparkPreset preset21{0x0,0x7f,"D99DC07A-C997-4ABD-833A-0C13EA8BEE5A","Comped Cleaner","0.7","Description for Bass Preset 1","icon.png",120.000000,7,{ 
...
const SparkPreset preset22{0x0,0x7f,"57AF2690-F7C8-4766-9A92-F3A51629B959","Cozy Serenade","0.7","Description for Acoustic Preset 1","icon.png",120.000000,7,{ 
...
const SparkPreset preset23{0x0,0x7f,"DEFBB271-B3EE-4C7E-A623-2E5CA53B6DDA","Studio Session","0.7","Description for Acoustic Preset 1","icon.png",120.000000,7,{ 
